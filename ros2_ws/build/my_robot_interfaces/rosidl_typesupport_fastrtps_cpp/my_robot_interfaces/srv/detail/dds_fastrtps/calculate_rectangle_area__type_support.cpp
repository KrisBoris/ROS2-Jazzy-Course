...
#include "my_robot_interfaces/srv/detail/calculate_rectangle_area__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::srv::CalculateRectangleArea_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::CalculateRectangleArea_Request & ros_message)
{
  // Member: height
  cdr >> ros_message.height;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::srv::CalculateRectangleArea_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
max_serialized_size_key_CalculateRectangleArea_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::CalculateRectangleArea_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::CalculateRectangleArea_Request *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, CalculateRectangleArea_Request)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::srv::CalculateRectangleArea_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: area
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::CalculateRectangleArea_Response & ros_message)
{
  // Member: area
  cdr >> ros_message.area;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::srv::CalculateRectangleArea_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
max_serialized_size_key_CalculateRectangleArea_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::CalculateRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::CalculateRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, CalculateRectangleArea_Response)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea_Response__handle;
}
...
// functions for my_robot_interfaces::srv::CalculateRectangleArea_Request already declared above

// functions for my_robot_interfaces::srv::CalculateRectangleArea_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::srv::CalculateRectangleArea_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::CalculateRectangleArea_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
max_serialized_size_CalculateRectangleArea_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CalculateRectangleArea_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CalculateRectangleArea_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::srv::CalculateRectangleArea_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
max_serialized_size_key_CalculateRectangleArea_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CalculateRectangleArea_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CalculateRectangleArea_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::CalculateRectangleArea_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::CalculateRectangleArea_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CalculateRectangleArea_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::CalculateRectangleArea_Event *>(
...
static size_t _CalculateRectangleArea_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CalculateRectangleArea_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CalculateRectangleArea_Event__callbacks = {
  "my_robot_interfaces::srv",
...
static rosidl_message_type_support_t _CalculateRectangleArea_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CalculateRectangleArea_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, CalculateRectangleArea_Event)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea_Event__handle;
}
...
static const rosidl_service_type_support_t _CalculateRectangleArea__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CalculateRectangleArea__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::srv::CalculateRectangleArea_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::srv::CalculateRectangleArea_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::srv::CalculateRectangleArea_Event>(),
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, CalculateRectangleArea)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_CalculateRectangleArea__handle;
}
