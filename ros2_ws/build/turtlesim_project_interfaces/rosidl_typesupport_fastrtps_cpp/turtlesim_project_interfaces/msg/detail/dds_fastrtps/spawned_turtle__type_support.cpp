...
#include "turtlesim_project_interfaces/msg/detail/spawned_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim_project_interfaces::msg::SpawnedTurtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlesim_project_interfaces::msg::SpawnedTurtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_project_interfaces::msg::SpawnedTurtle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpawnedTurtle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const turtlesim_project_interfaces::msg::SpawnedTurtle *>(
...
static size_t _SpawnedTurtle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpawnedTurtle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpawnedTurtle__callbacks = {
...
static rosidl_message_type_support_t _SpawnedTurtle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpawnedTurtle__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_turtlesim_project_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<turtlesim_project_interfaces::msg::SpawnedTurtle>()
{
  return &turtlesim_project_interfaces::msg::typesupport_fastrtps_cpp::_SpawnedTurtle__handle;
}
