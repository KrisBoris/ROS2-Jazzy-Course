...
static const _SpawnedTurtle_type_support_symbol_names_t _SpawnedTurtle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_project_interfaces, msg, SpawnedTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_project_interfaces, msg, SpawnedTurtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_project_interfaces, msg, SpawnedTurtle)() {
  return &::turtlesim_project_interfaces::msg::rosidl_typesupport_c::SpawnedTurtle_message_type_support_handle;
}
