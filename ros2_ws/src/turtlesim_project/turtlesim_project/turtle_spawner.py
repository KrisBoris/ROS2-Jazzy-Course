...
class TurtleSpawnerNode(Node):
    ...
    def __init__(self):
        ...
        self.__spawn_timer = self.create_timer(3.0, self.callback_spawn_timer)
    ...
    def callback_spawn_timer(self):
        ...
        future.add_done_callback(self.__callback_service_spawn)        
    ...
    def __callback_service_spawn(self, future):
